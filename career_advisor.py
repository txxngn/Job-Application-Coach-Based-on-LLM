...
def generate_career_advice(position_applied, job_description, resume_content):
    ...
    prompt = f"Considering the job description: {job_description}, and the resume provided: {resume_content}, \
        identify areas for enhancement in the resume. \
        Offer specific suggestions on how to improve these aspects to better match the job requirements \
        and increase the likelihood of being selected for the position of {position_applied}."
